...
public class JournalIntegration extends BaseComponentSystem {
    ...
    public void initialise() {
        ...
        List<JournalManager.JournalEntryPart> overview = Arrays.asList(
                ...
                new TextJournalPart("Using a hearth,  you can heat ore to melting point to get metal nuggets.  You need to heat your hearth by placing a fireplace next to it.  This does pose a problem, smoke is generated from burning materials."),
                new TextJournalPart("Burning materials poses a problem: smoke.  Smoke is generated when burning materials and floats upwards.  Please dont breathe in the smoke, it burns.  Use a stack of chimneys to pipe the smoke to outside where it can blow away."),
                new TitleJournalPart("Essence"),
                new TextJournalPart("Using a distiller,  you can break down blocks of matter into their contained essences. Each different kind of block has a unique composition of essence."),
                new TextJournalPart("These essences can then be reformed into blocks using the compactor.  Put a sample of the block into the template slot and supply the correct essences."),
                new TextJournalPart("Disobeying the laws of physics comes with a price: contamination.  Working with essences causes bits of the world to start turning sour.  Healing this contamination can put the world back in order."),
                new TitleJournalPart("Conveyors"),
                new TextJournalPart("Use these nifty contraptions to get items from point A to point B.  Item Extractors can take items out of chests and put them on to a conveyor.  Place them against the surface you want items to go in to."),
                new TitleJournalPart("Mechanical Power"),
                new TextJournalPart("Harness the power of rotational energy with either an engine or a windmill.  Feed an engine burnable material to produce energy.  Create a windmill sail and put it into a windmill block to produce energy."),
