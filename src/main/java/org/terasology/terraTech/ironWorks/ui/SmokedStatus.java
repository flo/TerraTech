...
public class SmokedStatus extends CoreWidget implements WorkstationUI {
    ...
    public void update(float delta) {
        ...
        if (content instanceof UILabel && station.exists()) {
            ...
            SmokeComponent smoke = station.getComponent(SmokeComponent.class);
            if (smoke != null) {
                status.setText("Smoke Damage");
            } else {
                status.setText("");
            }
        }
